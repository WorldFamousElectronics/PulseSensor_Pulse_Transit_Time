...
public class PulseSensor_Processing_PTT extends PApplet {
...
try{
 ...
 if (inData.charAt(0) == '|'){               // leading '|' means PTT data
     ...
     PTT = PApplet.parseInt(inData);                      // convert the string to usable int
   }
 }
  } catch(Exception e) {
    // print("Serial Error: ");
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "PulseSensor_Processing_PTT" };
    if (passedArgs != null) {
